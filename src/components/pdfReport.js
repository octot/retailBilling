...
const PdfReport = ({ itemsInPiecesList, image, sampleLogo, billNo, customerInfo, shipmentInfo, gstList, gstTotalFInalListMap, gstCellContainerValueMap, gstTotalValues, gstTotalList, paymentDetailsInfo, orderedBulletPoints }) => {
